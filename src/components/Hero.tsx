...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Bottom 3 Aligned Floating Badges */}
      <div className="absolute bottom-12 left-0 w-full px-8 z-10 flex justify-between items-end">
        ...
        <div className="bg-background/95 backdrop-blur-sm px-6 py-4 rounded-2xl shadow-elegant border border-primary/10">
          <div className="text-center group cursor-pointer">
            <div className="text-3xl font-bold bg-gradient-primary bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform">
              50+
            </div>
        ...
        <div className="bg-background/95 backdrop-blur-sm px-8 py-6 rounded-2xl shadow-elegant border border-primary/10 hidden sm:flex flex-col items-center">
        ...
        <div className="bg-background/95 backdrop-blur-sm px-8 py-6 rounded-2xl shadow-elegant border border-primary/10">
          <div className="flex items-center gap-4">
